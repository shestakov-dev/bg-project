		...
		<>
			...
			<Overlay visible={visible}>
				...
				<ul
					...
					<li>
						<b>W A S D</b> — движение в 3D пространството
					</li>
					<li>
					...
					<li>
						...
						могат да се избират планети и бутона "За проекта")
					</li>
					<li>
					...
					<li>
						<b>Клик върху планета</b> — отваря детайли за произведението (само извън
						режим на движение)
					</li>
					<li>
